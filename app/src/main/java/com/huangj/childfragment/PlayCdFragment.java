 ...
 */
public class PlayCdFragment extends BaseFragment {
    ...
    public int getContentId() {
        return R.layout.cdfragment_play;
    }
    ...
    protected void loadDatas() {
        ...
        //得到play头部图片的JSON;
        String json_food_header = GetJsonDatas.getJSON2("play_header.json", activity);
...
//        convenientBanner.getViewPager().setPageTransformer(true,new ());//设置特效;
        ...
        //得到Play的JSON；
        String json = GetJsonDatas.getJSON2("play.json",activity);
